...
import { TBurgerConstructorState } from './burger-constructor-slice';
...
const filledState: TBurgerConstructorState = {
  constructorItems: {
    bun: bunIngredient,
...
export { bunIngredient, mainIngredient, sauceIngredient, filledState };
